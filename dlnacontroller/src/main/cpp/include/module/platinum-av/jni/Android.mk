...
LOCAL_MODULE     := platinum-av-jni
LOCAL_SRC_FILES  := PltMicroMediaController.cpp platinum-cp-jni.cpp \
			PltMicroMediaServer.cpp platinum-ms-jni.cpp \
			PltMicroFileTransmitDevice.cpp platinum-ftd-jni.cpp \
			PltFileTransmitDevice.cpp PltFileTransmitControler.cpp
LOCAL_LDLIBS     += -llog
...
LOCAL_LDLIBS += -lPltMediaServer
LOCAL_LDLIBS += -lPltMediaRenderer
LOCAL_LDLIBS += -lPltMediaConnect
