...
struct fields_t {
	...
	jmethodID onTransmitFileSessionControlID;
	/* qiku end */
};
static fields_t fields;

static const char* const kClassDMCJniInterface = "com/qiku/android/avplayer/dlna/dmc/DMCJniInterface";
static const char* const kClassDeviceInfo = "com/qiku/android/avplayer/dlna/dmc/DeviceInfo";
static const char* const kClassItemInfo = "com/qiku/android/avplayer/dlna/dmc/ItemInfo";
static const char* const kClassFileInfo = "com/qiku/android/avplayer/dlna/dmc/FileInfo";
static int exit = 0; 
...
public:
    ...
    {
        NPT_LOG_INFO_2("name(%s), uuid(%s)", name, uuid);
    ...
    {
        NPT_LOG_INFO_3("res(%d), duration(%ld), relTime(%ld)", res, duration, relTime);
    ...
    virtual int onRapidTransmitVideo(const char* from, const char* filename)
    {
        NPT_LOG_INFO_2("from(%s), filename(%s)", from, filename);
        ...
        env->CallVoidMethod(mClient, fields.onRapidTransmitVideoMethodID, fromStr, filenameStr);
    ...
    virtual int onTransmitFileSessionControl(int res, int cmd, const char* sid, const char *from, const char* data)
    {
        NPT_LOG_INFO_2("from(%s), filename(%s)", from, data);

        if(fields.onTransmitFileSessionControlID == NULL) {
            NPT_LOG_INFO("onTransmitFileSessionControlID Method is null");
            return -1;
        }
        ...
        env->CallVoidMethod(mClient, fields.onTransmitFileSessionControlID, (jint)res,(jint)cmd, sidStr, fromStr, dataStr);

	    env->DeleteLocalRef(sidStr); 
	    env->DeleteLocalRef(fromStr); 
        env->DeleteLocalRef(dataStr); 
        checkAndClearExceptionFromCallback(env, "onTransmitFileSessionControlID");
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM* vm, void* reserved)
{
    ...
    if (dmcJniInterface == NULL) {
	    ...
	    fields.onRapidTransmitVideoMethodID = env->GetMethodID(dmcJniInterface,
                                "onRapidTransmitVideo", "(Ljava/lang/String;Ljava/lang/String;)V");
        if(fields.onRapidTransmitVideoMethodID == NULL) {
            NPT_LOG_INFO("Method onRapidTransmitVideo not found");
            checkAndClearExceptionFromCallback(env, "GetMethodID"); 
        }	

	    fields.onTransmitFileSessionControlID = env->GetMethodID(dmcJniInterface,
                                "onTransmitFileSessionControl", "(IILjava/lang/String;Ljava/lang/String;Ljava/lang/String;)V");
        if(fields.onTransmitFileSessionControlID == NULL) {
            NPT_LOG_INFO("Method onTransmitFileSessionControl not found");
            checkAndClearExceptionFromCallback(env, "GetMethodID"); 
        }	
...
/*
 * Class:     com_qiku_android_avplayer_dlna_DMCJniInterface
 * Method:    init
 * Signature: ()J
 */
PLT_UPnP* upnp = NULL;
JNIEXPORT jlong JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_init(JNIEnv *env, jobject thiz, jstring host)
{
    NPT_LOG_INFO("init version 3");
    ...
    int len = env->GetStringLength(host);
    env->GetStringUTFRegion(host, 0, len, hostname);
    PLT_MicroMediaController *self = new PLT_MicroMediaController(ctrlPoint, callback, hostname);
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getDmsList(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)[Ljava/lang/object;
 */
JNIEXPORT jobjectArray JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getDmrList(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)[Ljava/lang/object;
 */
JNIEXPORT jobjectArray JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getFtdList(JNIEnv *env, jobject thiz, jlong _self)
{
    NPT_LOG_INFO("getFtdList");
 ...
 * Signature: (JLjava/lang/string;)I
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_setDms(JNIEnv *env, jobject thiz, jlong _self, jstring dmsName)
{
    NPT_LOG_INFO("setDms");

    char dns_name[256];
    memset(dns_name, 0, 256);
 ...
 * Signature: (JLjava/lang/string;)I
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_setDmr(JNIEnv *env, jobject thiz, jlong _self, jstring dmrName)
{
    NPT_LOG_INFO("setDmr");

    char dmr_name[256];
    memset(dmr_name, 0, 256);
 ...
 * Signature: (JLjava/lang/string;)I
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_setFtd(JNIEnv *env, jobject thiz, jlong _self, jstring ftdName)
{
    char ftd_name[256];
    memset(ftd_name, 0, 256);
    int len = env->GetStringLength(ftdName);
    env->GetStringUTFRegion(ftdName, 0, len, ftd_name);
    NPT_LOG_INFO_1("setFtd %s", ftd_name);

    PLT_MicroMediaController* self = (PLT_MicroMediaController *)_self;

    return self->SetFtd(ftd_name);
}
 ...
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_entryDirectory(JNIEnv *env, jobject thiz, jlong _self, jstring dir)
{
 ...
 * Signature: (J)[Ljava/lang/object;
 */
JNIEXPORT jobjectArray JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getItemList(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 */
JNIEXPORT jobjectArray JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getFileList(JNIEnv *env, jobject thiz, jlong _self, jint flags)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getPositionInfo(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getTransportInfo(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getVolumeDBRange(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_setVolumeDB(JNIEnv *env, jobject thiz, jlong _self, jint voldb)
{
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_StartTransmitFile(JNIEnv *env, jobject thiz, jlong _self, jstring session_id, jstring filename, jstring size)
{
    NPT_LOG_INFO("StartTransmitFile");

    char str_filename[1024];
    memset(str_filename, 0, 1024);
    int len = env->GetStringLength(filename);
    env->GetStringUTFRegion(filename, 0, len, str_filename);
    NPT_LOG_INFO_1("filename: %s", str_filename);

    char str_filesize[1024];
    memset(str_filesize, 0, 1024);
    len = env->GetStringLength(size);
    env->GetStringUTFRegion(size, 0, len, str_filesize);
    NPT_LOG_INFO_1("filesize: %s", str_filesize);

    char str_sessionid[1024];
    memset(str_sessionid, 0, 1024);
    len = env->GetStringLength(session_id);
    env->GetStringUTFRegion(session_id, 0, len, str_sessionid);
    NPT_LOG_INFO_1("sid: %s", str_sessionid);

    PLT_MicroMediaController* self = (PLT_MicroMediaController *)_self;

    self->StartTransmitFile(str_sessionid, str_filename, str_filesize);
}
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_CancelTransmitFile(JNIEnv *env, jobject thiz, jlong _self, jstring session_id)
{
    NPT_LOG_INFO("CancelTransmitFile");

    char str_sessionid[1024];
    memset(str_sessionid, 0, 1024);
    int len = env->GetStringLength(session_id);
    env->GetStringUTFRegion(session_id, 0, len, str_sessionid);

    PLT_MicroMediaController* self = (PLT_MicroMediaController *)_self;

    self->CancelTransmitFile(str_sessionid);
}
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_FinishTransmitFile(JNIEnv *env, jobject thiz, jlong _self, jstring session_id)
{
    NPT_LOG_INFO("FinishTransmitFile");
    ...
    self->FinishTransmitFile(str_sessionid);
}
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_GetTransmitFileProgress(JNIEnv *env, jobject thiz, jlong _self, jstring session_id)
{
    NPT_LOG_INFO("GetTransmitFileProgress");
    ...
    self->GetTransmitFileProgress(str_sessionid);
}
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getVolumeDB(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getVolume(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (JI)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_setVolume(JNIEnv *env, jobject thiz, jlong _self, jint vol)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getMute(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 */
JNIEXPORT jstring JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_getDownloadUri(JNIEnv *env, jobject thiz, jlong _self, jstring uri, jint flags)
{
 ...
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlPlay2(JNIEnv *env, jobject thiz, jlong _self, jstring uri, jint flags)
{
 ...
 * Signature: (JLjava/lang/string;I)I
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlPlay(JNIEnv *env, jobject thiz, jlong _self, jstring uri, jint flags)
{
 ...
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlPlayOnline(JNIEnv *env, jobject thiz, jlong _self, jstring uri, jstring title, jint flags)
{
 ...
 * Signature: (JLjava/lang/string;)I
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlSeek(JNIEnv *env, jobject thiz, jlong _self, jstring relTime)
{
    NPT_LOG_INFO("ctrlSeek");

    char c_relTime[64];
    memset(c_relTime, 0, 64);
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlPause(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlResume(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (J)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlStop(JNIEnv *env, jobject thiz, jlong _self)
{
 ...
 * Signature: (JZ)V
 */
JNIEXPORT void JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_ctrlMute(JNIEnv *env, jobject thiz, jlong _self, jboolean mute)
{
 ...
 * Signature: (J)I
 */
JNIEXPORT jint JNICALL Java_com_qiku_android_avplayer_dlna_dmc_DMCJniInterface_uninit(JNIEnv *env, jobject thiz, jlong _self)
{
    NPT_LOG_INFO("uninit");
