...
public class SinaDLNA {
    ...
    static {
        try {
            Log.d(TAG, "loading library start");
    ...
    public native final int startMediaRender(String friendly_name)throws IllegalStateException, IllegalArgumentException,
            RuntimeException;

    public native final int stopMediaRender()throws IllegalStateException;

    public native final int startMediaServer(String path,String friendly_name)throws IllegalStateException, IllegalArgumentException,
            RuntimeException;

    public native final int stopMediaServer()throws IllegalStateException;
